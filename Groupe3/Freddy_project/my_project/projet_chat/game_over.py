...
def jump(): #fonction si on veut jouer encore
    music_play1()
...
boutton_commencer = customtkinter.CTkButton(fenetre,text="PLAY AGAIN",**Button_Style, command=jump) #bouton si pour rejouer et appelle au fonction game
