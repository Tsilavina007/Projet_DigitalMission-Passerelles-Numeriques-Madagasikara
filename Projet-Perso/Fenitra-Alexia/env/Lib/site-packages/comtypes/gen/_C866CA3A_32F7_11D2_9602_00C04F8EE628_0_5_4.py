...
__all__ = [
    ...
    'SPWORDPRONUNCIATION', 'SP_VISEME_15', 'SPWF_SRENGINE',
    'SpeechRecoEvents', 'DISPID_SRCEventInterests',
    'DISPID_SDKSetBinaryValue', 'DISPID_SRState',
    'DISPID_SpeechLexiconWords', 'DISPID_SOTRemoveStorageFileName',
    'ISpRecoContext2', 'SP_VISEME_4', 'SREFalseRecognition',
    'SAFT8kHz16BitStereo', 'SpSharedRecoContext', 'SGRSTTDictation',
    'SPCT_SUB_COMMAND', 'SRTReSent', 'DISPID_SRRTLength',
    'SpeechGrammarTagUnlimitedDictation', 'DISPID_SpeechPhraseInfo',
    'DISPID_SpeechPhraseProperty', 'DISPID_SPEAudioTimeOffset',
    'DISPID_SGRSTransitions', 'DISPID_SPEPronunciation',
    'SRSEIsSpeaking', 'SASStop', 'SPEI_SOUND_END',
    'eLEXTYPE_USER_SHORTCUT', 'SpeechAudioFormatType',
    'eLEXTYPE_PRIVATE18', 'SVP_19', 'SVSFNLPMask',
    'DISPID_SRCESoundEnd', 'SpeechSpecialTransitionType',
    'SPEI_PROPERTY_NUM_CHANGE', 'SPEI_INTERFERENCE',
    'DISPID_SGRsCommitAndSave', 'ISpeechGrammarRuleStateTransitions',
    'DISPID_SVSLastResult', 'DISPID_SAFType', 'SPVISEMES',
    'SpInProcRecoContext', 'SPCS_DISABLED', 'SpeechFormatType',
    'DISPID_SGRSTRule', 'DISPID_SRCEInterference', 'SVEPrivate',
    'DISPID_SGRsItem', 'DISPID_SAFGuid', 'SAFT16kHz16BitStereo',
    'SPWT_PRONUNCIATION', 'DISPID_SRCCreateResultFromMemory',
    'SP_VISEME_13', 'DISPID_SPEsItem', 'SREPhraseStart',
    'DISPID_SRCERecognizerStateChange', 'SREHypothesis',
    'SPEVENTENUM', 'DISPID_SVEStreamEnd', 'DISPID_SPAs_NewEnum',
    'DISPID_SpeechGrammarRuleStateTransition', 'SSFMOpenReadWrite',
    'STCInprocHandler', 'DISPID_SRCRequestedUIType',
    'DISPID_SBSFormat', 'DISPID_SRCBookmark', 'DISPID_SRIsShared',
    'ISpResourceManager', 'DISPID_SGRsCommit', 'SVSFPurgeBeforeSpeak',
    'DISPID_SpeechVoice', 'SpCompressedLexicon', 'DISPID_SGRsDynamic',
    'DISPID_SVEEnginePrivate', 'SpeechAudioFormatGUIDText',
    'DISPID_SGRAddResource', 'SpeechMicTraining', 'ISequentialStream',
    'SVSFlagsAsync', 'SpSharedRecognizer', 'SAFTADPCM_11kHzMono',
    'DISPID_SPIGetText', 'DISPID_SMSAMMHandle', 'SPLO_DYNAMIC',
    'SVP_4', 'DISPID_SPRNumberOfElements', 'SINoise',
    'DISPID_SpeechPhraseBuilder', 'SVP_17', 'ISpRecognizer2',
    'ISpeechPhraseElements', 'SpeechRunState', 'SpStream',
    'SPWT_DISPLAY', 'DISPID_SVPause', 'DISPID_SpeechPhraseElement',
    'SPAS_STOP', 'SpVoice', 'DISPID_SPEs_NewEnum', 'SRATopLevel',
    'SpNullPhoneConverter', 'SPPS_RESERVED2', 'eLEXTYPE_PRIVATE9',
    'ISpEventSource', 'DISPID_SVSpeak', 'SAFT32kHz16BitStereo',
    'DISPID_SPPConfidence', 'SpeechPropertyResourceUsage',
    'DISPID_SVEventInterests', 'SPDATAKEYLOCATION', 'SPSFunction',
    'SECFIgnoreWidth', 'DISPID_SpeechPhraseAlternate', 'SP_VISEME_14',
    'DISPID_SRGetFormat', 'DISPID_SVPriority', 'SPRST_ACTIVE_ALWAYS',
    'SAFTCCITT_ALaw_44kHzStereo', 'SSTTDictation',
    ...
    'SpeechCategoryVoices', 'eWORDTYPE_ADDED',
    'DISPID_SOTGetAttribute', 'DISPID_SGRSTNextState',
    'DISPID_SOTCEnumerateTokens', 'DISPID_SRCSetAdaptationData',
    'SPINTERFERENCE_TOOLOUD', 'IInternetSecurityMgrSite',
    'DISPID_SPAsCount', 'DISPID_SpeechPhoneConverter',
    'SpeechVoiceEvents', 'SAFT22kHz8BitStereo', 'SPEI_TTS_BOOKMARK',
    'SpeechEngineProperties', 'eLEXTYPE_PRIVATE10', 'SVSFParseSapi',
    'SPWAVEFORMATTYPE', 'SpeechCategoryRecoProfiles',
    'ISpeechRecognizer', 'SPLOADOPTIONS',
    'DISPID_SPPEngineConfidence', 'SVP_8', 'DISPID_SGRSTPropertyName',
    'DISPID_SVIsUISupported', 'DISPID_SASCurrentDevicePosition',
    'DISPID_SRRAlternates', 'DISPID_SRStatus',
    'SpeechCategoryAudioIn', 'DISPID_SRGetPropertyString',
    'DISPID_SRGState', 'SRESoundStart', 'SPSNotOverriden',
    'DISPID_SGRClear', 'STSF_FlagCreate', 'SPBO_PAUSE',
    'DISPID_SFSClose', 'SAFT24kHz16BitStereo', 'SpWaveFormatEx',
    'DISPID_SRRDiscardResultInfo',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'DISPID_SPRuleFirstElement', 'DISPID_SDKGetBinaryValue',
    'DISPID_SWFEAvgBytesPerSec', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'SSSPTRelativeToCurrentPosition', 'SPSEMANTICFORMAT',
    'SPEI_SR_RETAINEDAUDIO', 'DISPID_SpeechRecoResult2',
    'DISPID_SpeechAudioFormat', 'DISPID_SRRecognizer',
    'SPSEMANTICERRORINFO', 'SpeechTokenKeyUI', 'eWORDTYPE_DELETED',
    'SVP_3', 'ISpeechCustomStream', 'ISpeechGrammarRules',
    'DISPID_SAVolume', 'DISPID_SpeechPhraseReplacement',
    'DISPID_SRAudioInput', 'DISPID_SAStatus', 'SPINTERFERENCE_NONE',
    'SPINTERFERENCE_LATENCY_WARNING', 'eLEXTYPE_PRIVATE4',
    'SWTDeleted', 'DISPID_SRProfile', 'eLEXTYPE_PRIVATE11',
    'SpeechCategoryRecognizers', 'SpUnCompressedLexicon',
    'DISPID_SPPBRestorePhraseFromMemory', 'SPRECORESULTTIMES',
    'SpeechTokenKeyAttributes', 'SVP_5', 'ISpeechRecoResultDispatch',
    'DISPID_SRAudioInputStream', 'DISPID_SGRSTPropertyValue',
    'SPEI_TTS_PRIVATE', 'SPRS_ACTIVE', 'SDA_Two_Trailing_Spaces',
    'SPAR_Low', 'SpShortcut', 'ISpDataKey',
    'SpPhoneticAlphabetConverter', 'SPGS_ENABLED',
    'SpeechRecognitionType', 'SAFTADPCM_8kHzStereo',
    'SpeechPropertyAdaptationOn', 'DISPID_SRRAudio', 'SVP_6',
    'SPAR_Unknown', 'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'ISpeechPhraseRule', 'SPEI_SENTENCE_BOUNDARY',
    'SPFM_CREATE_ALWAYS', 'SAFT12kHz8BitStereo', 'DISPID_SBSSeek',
    'DISPID_SLGetGenerationChange',
    'ISpeechGrammarRuleStateTransition', 'SAFTCCITT_ALaw_8kHzStereo',
    'DISPID_SVRate', 'SpeechDiscardType', 'SAFT11kHz16BitStereo',
    'SVP_9', 'ISpPhoneConverter', 'SREPropertyStringChange',
    'SPRST_ACTIVE', 'SLTApp', 'SPRECOGNIZERSTATUS',
    'SPWORDPRONOUNCEABLE', 'SPPHRASE', 'DISPID_SpeechXMLRecoResult',
    'SRAORetainAudio', 'IEnumSpObjectTokens', 'SPEI_RESERVED2',
    'SP_VISEME_2', 'SPFM_OPEN_READONLY', 'DISPID_SVAudioOutputStream',
    ...
    'eLEXTYPE_PRIVATE19', 'DISPID_SLPs_NewEnum',
    'DISPID_SGRSTs_NewEnum', 'SRARoot', 'DISPID_SPRsCount',
    'DISPID_SABufferNotifySize', 'SpeechRegistryUserRoot',
    'SDKLDefaultLocation', 'SWPUnknownWordUnpronounceable',
    'SVF_Stressed', 'STCInprocServer', 'DISPID_SVVoice',
    'DISPID_SGRAttributes', 'SpFileStream', 'SPSVerb',
    'ISpeechBaseStream', 'SpeechEngineConfidence', 'SRAExport',
    'ISpeechLexiconWord', 'SpMMAudioIn', 'SAFTCCITT_uLaw_8kHzMono',
    'ISpeechObjectToken', 'SPSNoun', 'ISpeechRecoResult',
    'WAVEFORMATEX', 'DISPID_SWFEBitsPerSample',
    'DISPID_SpeechWaveFormatEx', 'SPEI_MAX_SR',
    'DISPID_SRCAudioInInterferenceStatus',
    'DISPID_SRGCmdLoadFromObject', 'SGDSActive',
    'DISPID_SASFreeBufferSpace', 'DISPID_SVGetProfiles',
    'DISPID_SpeechLexicon', 'ISpNotifySink', 'DISPID_SOTRemove',
    'SPEI_PHRASE_START', 'ISpStream', 'SPSLMA', 'SP_VISEME_7',
    'SVP_18', 'ISpeechPhraseElement', 'DISPID_SPRuleName',
    'DISPID_SVSpeakStream', 'SpeechGrammarWordType',
    'ISpObjectTokenCategory', 'DISPID_SVStatus',
    'DISPID_SVSLastBookmarkId', 'DISPID_SVSVisemeId',
    'SECFIgnoreCase', 'eLEXTYPE_PRIVATE1', 'DISPID_SRDisplayUI',
    'DISPID_SpeechRecognizerStatus', 'ISpMMSysAudio',
    'DISPID_SDKSetLongValue', 'DISPID_SPELexicalForm',
    'eLEXTYPE_RESERVED6', 'SpeechLexiconType',
    'SAFTCCITT_uLaw_8kHzStereo', 'SPPHRASEREPLACEMENT', 'SPPS_Verb',
    'DISPID_SGRName', 'eLEXTYPE_PRIVATE14', 'eLEXTYPE_LETTERTOSOUND',
    'SPINTERFERENCE', 'DISPID_SPEDisplayAttributes',
    'SVEWordBoundary', 'SP_VISEME_16', 'DISPID_SPEAudioSizeTime',
    'SRTExtendableParse', 'SPINTERFERENCE_TOOSLOW',
    'SSSPTRelativeToStart', 'SPCATEGORYTYPE',
    'DISPID_SABIMinNotification', 'DISPID_SRRTTickCount',
    'SPCT_DICTATION', 'SPEI_PROPERTY_STRING_CHANGE',
    'STCRemoteServer', 'SLOStatic', 'SpeechAudioState',
    'SpeechWordType', 'DISPID_SPPChildren', 'SAFT48kHz8BitMono',
    'ISpeechMemoryStream', 'DISPID_SGRSRule', 'DISPID_SRGCommit',
    'SAFTCCITT_uLaw_44kHzMono', 'STSF_LocalAppData', 'ISpRecoResult',
    'DISPID_SRCEPropertyNumberChange', 'DISPID_SGRs_NewEnum',
    'ISpRecoGrammar2', 'DISPID_SPPId', 'DISPID_SRGDictationUnload',
    'eLEXTYPE_PRIVATE13', 'SDTRule', 'DISPID_SVEAudioLevel',
    'DISPID_SPRuleConfidence', 'SPAO_NONE', 'SRTAutopause',
    'SAFTCCITT_uLaw_22kHzStereo', 'SAFTCCITT_ALaw_11kHzMono',
    'SAFTADPCM_22kHzMono', 'DISPID_SVGetAudioOutputs',
    'SREAudioLevel', 'SPPS_Function', 'SSFMCreateForWrite',
    'DISPID_SRCERecognition', 'DISPID_SOTGetStorageFileName',
    'SpeechTokenShellFolder', 'DISPID_SPPParent',
    'DISPID_SPIElements', 'ISpRecognizer3', 'SpeechVisemeType',
    'DISPID_SRCVoicePurgeEvent', 'DISPID_SLWWord', 'SREStateChange',
    'ISpeechGrammarRule', 'DISPID_SPRs_NewEnum', 'DISPID_SGRSTsItem',
    'DISPID_SLAddPronunciationByPhoneIds', 'eLEXTYPE_PRIVATE20',
    'SpeechCategoryAppLexicons', 'DISPID_SpeechLexiconProns',
    'DISPID_SRCCreateGrammar', 'SPINTERFERENCE_TOOQUIET',
    'DISPID_SRRSpeakAudio', 'SGLexical', 'eLEXTYPE_USER',
    'SRTEmulated', 'DISPID_SLGetPronunciations',
    'DISPID_SpeechLexiconWord', 'DISPID_SLGetWords',
    'SWPKnownWordPronounceable', 'DISPID_SRSSupportedLanguages',
    'SAFTCCITT_ALaw_44kHzMono', 'SPINTERFERENCE_NOISE',
    'DISPID_SpeechGrammarRules', 'DISPID_SGRSAddSpecialTransition',
    'DISPID_SPPNumberOfElements', 'DISPID_SRCEFalseRecognition',
    'SPPS_Interjection', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'SPCT_COMMAND', 'SAFT24kHz8BitMono',
    'DISPID_SRSCurrentStreamPosition', 'SPINTERFERENCE_TOOFAST',
    'DISPID_SOTCGetDataKey', 'SpResourceManager',
    'DISPID_SPISaveToMemory', 'SpeechTokenValueCLSID',
    'DISPID_SRRSaveToMemory', 'SPEI_REQUEST_UI', 'DISPID_SVEWord',
    'DISPID_SPEAudioStreamOffset', 'SVP_1', 'SPSMF_SAPI_PROPERTIES',
    'SVEViseme', '_RemotableHandle', 'DISPID_SRCRetainedAudioFormat',
    'DISPID_SOTDisplayUI', 'SAFTCCITT_ALaw_11kHzStereo',
    'DISPID_SLWsItem', 'SPSHT_Unknown', 'SPRS_ACTIVE_USER_DELIMITED',
    'ISpeechPhraseProperty', 'DISPID_SPIStartTime',
    'DISPID_SVGetAudioInputs', 'DISPID_SOTGetDescription',
    'SpeechGrammarRuleStateTransitionType', 'SPRS_INACTIVE',
    'SVSFIsXML', 'SAFTDefault', 'DISPID_SRGIsPronounceable',
    'SRSActive', 'SDTProperty', 'DISPID_SABIBufferSize',
    'ISpeechPhraseInfo', 'SVEBookmark', 'DISPID_SPIEngineId',
    'DISPID_SRCState', 'SVSFPersistXML', 'SPBO_AHEAD',
    'DISPID_SPEActualConfidence', 'SPLO_STATIC', 'SREStreamStart',
    'eLEXTYPE_PRIVATE5', 'SVSFNLPSpeakPunc', 'SAFT32kHz8BitStereo',
    'DISPID_SpeechRecoContext', 'SpeechBookmarkOptions',
    'ISpeechRecoContext', 'ISpAudio', 'DISPID_SMSALineId',
    'SECLowConfidence', 'SPPS_LMA', '_ISpeechRecoContextEvents',
    'DISPID_SVSCurrentStreamNumber', 'SPPS_Unknown', 'SPRST_INACTIVE',
    'eLEXTYPE_PRIVATE2', 'SPWT_LEXICAL', 'SP_VISEME_21',
    'DISPID_SVSLastBookmark', 'SVEAllEvents', 'SpeechInterference',
    'DISPID_SRCreateRecoContext', 'DISPID_SGRId',
    'Speech_StreamPos_RealTime', 'SPPS_Modifier', 'SpAudioFormat',
    'SITooFast', 'DISPID_SVEPhoneme', 'DISPID_SGRInitialState',
    'DISPID_SGRsCount', 'DISPID_SLWsCount',
    'DISPID_SVSInputSentenceLength', 'DISPID_SRGSetTextSelection',
    'SpeechRetainedAudioOptions', 'SGRSTTWildcard',
    'ISpeechAudioBufferInfo', 'SAFT48kHz16BitStereo',
    'SPSMF_SRGS_SAPIPROPERTIES', 'DISPID_SPERequiredConfidence',
    'SpeechPropertyNormalConfidenceThreshold', 'SPSHORTCUTPAIRLIST',
    'DISPID_SPEEngineConfidence', 'SPEI_MAX_TTS',
    'DISPID_SpeechGrammarRuleState', 'SPPS_Noncontent', 'SPSMF_UPS',
    'SPSHT_OTHER', 'ISpeechObjectTokens', 'SREPropertyNumChange',
    'SPVPRI_OVER', 'DISPID_SpeechPhraseAlternates', 'SLTUser',
    'DISPID_SPIAudioSizeBytes', 'SPGRAMMARSTATE',
    'DISPID_SVWaitUntilDone', 'ISpLexicon',
    'ISpeechLexiconPronunciation', 'SREStreamEnd',
    'DISPID_SWFESamplesPerSec', 'DISPID_SRGetRecognizers',
    'ISpGrammarBuilder', 'SVF_None', 'SPWORD',
    'SPINTERFERENCE_NOSIGNAL',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SRCEEnginePrivate', 'DISPID_SLPsCount',
    'SVESentenceBoundary', 'SVPOver', 'ISpSerializeState',
    'DISPID_SPRuleChildren', 'SASClosed', 'SVP_20', 'SRCS_Enabled',
    'ISpeechPhoneConverter', 'ISpeechLexiconPronunciations',
    'SpeechUserTraining', 'SPSSuppressWord', 'DISPID_SPRText',
    'DISPIDSPTSI_SelectionOffset', 'SPPHRASEPROPERTY', 'SRSEDone',
    'ISpeechAudioFormat', 'DISPID_SCSBaseStream',
    'DISPID_SABufferInfo', 'SAFT44kHz8BitMono',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'DISPID_SVAlertBoundary',
    'SECNormalConfidence', 'DISPID_SLPPartOfSpeech',
    'SpeechStreamSeekPositionType', 'DISPID_SDKOpenKey',
    'DISPID_SGRSTsCount', 'SP_VISEME_19', 'SSFMOpenForRead',
    'DISPID_SVSpeakCompleteEvent', 'DISPID_SRCEPropertyStringChange',
    'DISPID_SOTs_NewEnum', 'SRAImport', 'DISPID_SPEAudioSizeBytes',
    'SSTTWildcard', 'SpeechVoiceSkipTypeSentence', 'DISPID_SASState',
    'SVP_10', 'DISPID_SRCEStartStream', 'ISpeechAudio',
    'SPEI_RECOGNITION', 'SPEI_RESERVED1', 'SAFT8kHz16BitMono',
    'ISpeechPhraseInfoBuilder', 'ISpeechLexiconWords',
    'SPEI_SR_BOOKMARK', 'DISPID_SVEBookmark', 'SGDSInactive',
    'ISpeechWaveFormatEx', 'SpeechAddRemoveWord',
    'SVEStartInputStream', 'SPAR_Medium', 'ISpeechLexicon',
    'DISPID_SMSGetData', 'DISPID_SpeechPhraseReplacements',
    'DISPID_SOTSetId', 'SVSFParseSsml',
    'DISPID_SVSInputSentencePosition', 'SPFM_CREATE',
    'SAFT44kHz16BitStereo', 'SPVPRIORITY', 'SPXRO_SML',
    'SPPS_RESERVED1', 'SPPROPERTYINFO', 'SDKLCurrentConfig', 'SDTAll',
    'SpeechWordPronounceable', 'Speech_Max_Pron_Length',
    'SAFT16kHz8BitStereo', 'SDTLexicalForm', 'DISPID_SASetState',
    'SP_VISEME_17', 'SPPS_NotOverriden', 'SpCustomStream',
    'DISPID_SPAPhraseInfo', 'DISPID_SVVolume', 'DISPID_SRRPhraseInfo',
    'SBONone', 'SPAUDIOSTATE', 'DISPID_SVSLastStreamNumberQueued',
    'SGRSTTEpsilon', 'STSF_CommonAppData', 'SLODynamic',
    'ISpeechResourceLoader', 'DISPID_SRGCmdSetRuleIdState',
    'SAFTCCITT_ALaw_8kHzMono', 'ISpeechVoiceStatus', 'SASPause',
    'STSF_AppData', 'SAFT8kHz8BitMono', 'DISPID_SDKCreateKey',
    'SAFT22kHz8BitMono', 'SVSFIsFilename', 'SpMemoryStream',
    'SPRECOSTATE', 'eLEXTYPE_PRIVATE3', 'SVSFIsNotXML',
    'SPSERIALIZEDRESULT', 'SDTAlternates',
    'SpeechEmulationCompareFlags', 'SREInterference',
    'SWPUnknownWordPronounceable', 'SP_VISEME_20',
    'DISPID_SVSPhonemeId', 'DISPID_SPRuleEngineConfidence',
    'SITooSlow', 'DISPID_SVSInputWordLength',
    'ISpeechPhraseAlternate', 'ISpeechDataKey',
    'DISPID_SVSInputWordPosition', 'DISPID_SVEViseme',
    'DISPID_SpeechPhraseProperties', 'DISPID_SDKGetlongValue',
    'SpTextSelectionInformation', 'SpPhoneConverter',
    'ISpeechObjectTokenCategory', 'SRADefaultToActive',
    'DISPID_SPERetainedSizeBytes', 'DISPID_SRGReset',
    'DISPID_SpeechAudioStatus', 'SGPronounciation',
    'eLEXTYPE_PRIVATE12', 'SVP_12', 'DISPID_SVSRunningState',
    'DISPID_SOTsCount', 'eLEXTYPE_PRIVATE8', 'DISPID_SpeechDataKey',
    'DISPID_SWFEExtraData', 'DISPID_SOTsItem', 'DISPID_SRCPause',
    'SAFTADPCM_44kHzMono', 'DISPID_SRRGetXMLResult', 'SVEPhoneme',
    'DISPID_SRCRetainedAudio', 'SINoSignal',
    'DISPID_SASNonBlockingIO', 'SPPHRASEELEMENT',
    'DISPID_SREmulateRecognition', 'DISPID_SLPPhoneIds',
    'ISpeechPhraseAlternates', 'DISPID_SPIAudioStreamPosition',
    'SRAONone', 'ISpRecognizer', 'DISPID_SPCPhoneToId',
    'ISpXMLRecoResult', 'SECFIgnoreKanaType', 'SDKLLocalMachine',
    'eLEXTYPE_RESERVED10', 'DISPID_SPIRetainedSizeBytes',
    'DISPID_SpeechMMSysAudio', 'SPEI_HYPOTHESIS',
    'DISPID_SpeechPhraseElements', 'DISPID_SpeechObjectTokenCategory',
    'DISPID_SDKSetStringValue', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'SpeechLoadOption', 'DISPID_SPEDisplayText', 'DISPID_SPRsItem',
    'SPWORDTYPE', 'DISPID_SGRsAdd', 'DISPID_SPIAudioSizeTime',
    'DISPID_SRSNumberOfActiveRules', 'eLEXTYPE_PRIVATE17', 'SAFTText',
    'DISPID_SAFSetWaveFormatEx', 'SP_VISEME_5', 'SVSFParseAutodetect',
    'SPSHT_EMAIL', 'DISPID_SRGSetWordSequenceData',
    'DISPID_SRGCmdLoadFromResource', 'DISPID_SRCEEndStream',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SECFDefault',
    'tagSPPROPERTYINFO', 'SPEI_FALSE_RECOGNITION',
    'SPPS_SuppressWord', 'SPSTREAMFORMATTYPE', 'SPDKL_LocalMachine',
    'SpNotifyTranslator', 'SPFM_OPEN_READWRITE',
    'DISPID_SRIsUISupported', 'DISPID_SPACommit', 'SPAS_RUN',
    'DISPID_SPIGrammarId', 'ISpObjectWithToken', 'SVP_13',
    'DISPID_SDKGetStringValue', 'DISPID_SRCEBookmark', 'SPWF_INPUT',
    'DISPID_SAEventHandle', 'DISPID_SPPsItem', 'DISPID_SPCIdToPhone',
    'SVP_15', 'DISPID_SPRuleNumberOfElements',
    'ISpeechGrammarRuleState', 'ISpeechAudioStatus',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SSSPTRelativeToEnd',
    'SPEI_START_INPUT_STREAM', 'SpObjectTokenCategory',
    'DISPID_SPRulesCount', 'SPWORDPRONUNCIATIONLIST',
    'DISPID_SMSADeviceId', 'DISPID_SPRulesItem', 'SpMMAudioEnum',
    'DISPID_SLPLangId', 'DISPID_SABIEventBias',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SpeechPartOfSpeech',
    'IStream', 'ISpPhoneticAlphabetConverter',
    'SPADAPTATIONRELEVANCE', 'SpeechDisplayAttributes',
    'SVEVoiceChange', 'SVF_Emphasis', 'SVP_11', 'ISpeechFileStream',
    'DISPID_SLAddPronunciation', 'DISPID_SVEVoiceChange', 'SWTAdded',
    'DISPID_SGRSTText', 'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'SRTSMLTimeout', 'DISPID_SLRemovePronunciation',
    'DISPID_SRGDictationLoad', 'SpeechRecoContextState',
    'SPSModifier', 'SRADynamic', 'ISpPhrase', 'SpeechDataKeyLocation',
    'DISPID_SGRAddState', 'SAFTADPCM_8kHzMono', 'STCLocalServer',
    'SFTSREngine', 'DISPID_SPPs_NewEnum', 'DISPID_SGRSTWeight',
    'SAFT22kHz16BitMono', 'SPVPRI_ALERT', 'SPAR_High',
    'SDKLCurrentUser', 'DISPID_SRRTStreamTime', 'ISpEventSink',
    'Speech_StreamPos_Asap', 'DISPID_SVSyncronousSpeakTimeout',
    'SPRULE', 'ISpPhraseAlt', 'SGRSTTTextBuffer',
    'eLEXTYPE_RESERVED9', 'SVPAlert', 'SP_VISEME_9', 'SPAUDIOSTATUS',
    'LONG_PTR', 'DISPID_SDKDeleteValue', 'SVSFDefault',
    'SREAllEvents', 'DISPID_SPIRule', 'DISPIDSPTSI_ActiveLength',
    'SPEI_RECO_STATE_CHANGE', 'STCAll', 'DISPID_SRCRecognizer',
    'DISPID_SPCLangId', 'SAFT12kHz16BitStereo', 'SVEAudioLevel',
    'ISpStreamFormatConverter', 'SAFT24kHz8BitStereo',
    'SAFT16kHz16BitMono', 'SP_VISEME_8',
    'SpeechCategoryPhoneConverters', 'DISPID_SRSAudioStatus',
    'SRSActiveAlways', 'UINT_PTR', 'SP_VISEME_3',
    'DISPID_SAFGetWaveFormatEx', 'DISPID_SPPName',
    'SPDKL_CurrentConfig', 'SAFTGSM610_22kHzMono',
    'DISPID_SVAudioOutput', 'SpMMAudioOut', 'SPAO_RETAIN_AUDIO',
    'SPAUDIOOPTIONS', 'SpeechPropertyHighConfidenceThreshold',
    'SpeechGrammarTagWildcard', 'ISpProperties',
    'DISPID_SLRemovePronunciationByPhoneIds',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'ISpStreamFormat',
    'DISPID_SPARecoResult', 'SPXRO_Alternates_SML',
    'DISPID_SGRSAddRuleTransition', 'DISPID_SpeechAudioBufferInfo',
    'SVP_7', 'DISPID_SOTCategory', 'eLEXTYPE_PRIVATE6',
    'DISPID_SPEsCount', 'DISPID_SLWPronunciations',
    'DISPID_SDKEnumKeys', 'DISPID_SRGCmdSetRuleState', 'SPAS_CLOSED',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SPSInterjection',
    'DISPID_SRCResume', 'SpeechPropertyLowConfidenceThreshold',
    'SGSExclusive', 'SPEVENT', 'SPCONTEXTSTATE', 'SVP_2',
    'eLEXTYPE_PRIVATE7', 'DISPID_SWFEBlockAlign', 'SPBOOKMARKOPTIONS',
    'DISPID_SRSetPropertyNumber', 'SAFTNonStandardFormat',
    'ISpRecoGrammar', 'SAFTGSM610_44kHzMono', 'SVSFUnusedFlags',
    'SAFT48kHz8BitStereo', 'SpPhraseInfoBuilder',
    'DISPID_SpeechLexiconPronunciation', 'SPTEXTSELECTIONINFO',
    'eLEXTYPE_RESERVED8', 'SPEI_MIN_SR',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SPEI_SR_PRIVATE',
    'DISPID_SWFEChannels', 'SPEI_END_INPUT_STREAM',
    'SPSHT_NotOverriden', 'SpeechVoicePriority', 'DISPID_SOTDataKey',
    'SAFT32kHz16BitMono', 'SpeechTokenKeyFiles',
    'DISPID_SVEStreamStart', 'SpeechAudioProperties', 'SRSInactive',
    'tagSPTEXTSELECTIONINFO', 'SVPNormal', 'SAFTGSM610_11kHzMono',
    'SPEI_END_SR_STREAM', 'SGSEnabled', 'SpeechRuleState',
    'DISPID_SOTIsUISupported', 'SECFNoSpecialChars',
    'SAFT11kHz8BitMono', 'SpeechGrammarTagDictation',
    'DISPID_SVResume', 'SPRST_NUM_STATES', 'SPCS_ENABLED',
    'SAFT16kHz8BitMono', 'SGRSTTRule', 'DISPID_SPRDisplayAttributes',
    'DISPID_SPANumberOfElementsInResult', 'SPPS_RESERVED3',
    'DISPID_SpeechBaseStream', 'SBOPause', 'DISPID_SOTCSetId',
    'DISPID_SRGDictationSetState', 'DISPID_SRSetPropertyString',
    'DISPID_SLWType', 'SAFTCCITT_ALaw_22kHzMono',
    'DISPIDSPTSI_ActiveOffset', 'DISPID_SRGId',
    'SpeechRegistryLocalMachineRoot', 'ISpeechXMLRecoResult',
    'DISPIDSPRG', 'SPEI_TTS_AUDIO_LEVEL', 'SpeechTokenContext',
    'SVEEndInputStream', 'DISPID_SpeechGrammarRule', 'DISPID_SBSRead',
    'SPSHORTCUTTYPE', 'SECFEmulateResult',
    'SDA_Consume_Leading_Spaces', 'SPEI_RESERVED5', 'SRERecognition',
    'SPCT_SLEEP', 'DISPID_SVESentenceBoundary',
    'DISPID_SGRSTPropertyId', 'SpObjectToken',
    'SpeechPropertyResponseSpeed', 'SPEI_SOUND_START',
    'DISPID_SOTCDefault', 'SPSERIALIZEDPHRASE',
    'SAFTCCITT_ALaw_22kHzStereo', 'SRSInactiveWithPurge', 'SITooLoud',
    'SPLEXICONTYPE', 'SPRST_INACTIVE_WITH_PURGE',
    'DISPID_SpeechObjectTokens', 'tagSTATSTG',
    'DISPID_SRGCmdLoadFromMemory', 'SPAUDIOBUFFERINFO',
    'SPPARTOFSPEECH', 'SPEI_VOICE_CHANGE', 'ISpeechRecoResult2',
    'DISPID_SPRFirstElement', 'DISPID_SPRuleId', 'SPEI_UNDEFINED',
    'DISPID_SpeechRecoResult', 'SpeechAudioFormatGUIDWave',
    'DISPID_SRGetPropertyNumber', 'DISPID_SpeechVoiceEvent',
    'SPBO_TIME_UNITS', 'SPVPRI_NORMAL', 'SDA_One_Trailing_Space',
    'SRAInterpreter', 'SVP_14', 'eLEXTYPE_RESERVED4', 'SPPS_Noun',
    'SPPS_RESERVED4', 'DISPID_SpeechRecoResultTimes', 'SPVOICESTATUS',
    'eLEXTYPE_APP', 'IInternetSecurityManager', 'SSFMCreate',
    'SP_VISEME_10', 'SPFILEMODE', 'SAFT11kHz16BitMono',
    'DISPID_SRCERequestUI', 'SRTStandard', 'SP_VISEME_12',
    'SAFTNoAssignedFormat', 'SREBookmark', 'DISPID_SPRules_NewEnum',
    'SINone', 'SGSDisabled', 'SpStreamFormatConverter',
    'DISPID_SRRRecoContext', 'SpeechRecoProfileProperties',
    'ISpeechPhraseRules', 'SPEI_START_SR_STREAM', 'ISpeechMMSysAudio',
    'Speech_Max_Word_Length', 'SDTPronunciation', 'SFTInput',
    'DISPID_SRCCmdMaxAlternates', 'DISPID_SGRsFindRule',
    'DISPID_SDKEnumValues', 'SAFTCCITT_uLaw_44kHzStereo',
    'eLEXTYPE_PRIVATE15', 'SAFT8kHz8BitStereo', 'SPBINARYGRAMMAR',
    'SpInprocRecognizer', 'SPEI_RECO_OTHER_CONTEXT',
    'SDA_No_Trailing_Space', 'DISPID_SpeechObjectToken',
    'DISPID_SpeechCustomStream', 'DISPID_SRSCurrentStreamNumber',
    'SAFTTrueSpeech_8kHz1BitMono', 'SPXMLRESULTOPTIONS',
    'DISPID_SOTCId', 'ISpPhoneticAlphabetSelection', 'ISpVoice',
    'ISpRecoContext', 'SPEI_VISEME', 'SpeechGrammarState',
    'ISpObjectToken', 'SpeechRuleAttributes',
    'DISPID_SOTCreateInstance',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'DISPID_SLGenerationId',
    'DISPID_SRCERecognitionForOtherContext', 'SP_VISEME_18',
    'DISPID_SPAsItem', 'DISPID_SPERetainedStreamOffset',
    'SPDKL_CurrentUser', 'DISPID_SADefaultFormat',
    'DISPID_SRRTOffsetFromStart', 'SPGRAMMARWORDTYPE',
    'SPEI_WORD_BOUNDARY', 'SGLexicalNoSpecialChars',
    'DISPID_SRSClsidEngine', 'SPGS_EXCLUSIVE', 'SSTTTextBuffer',
    'SPEI_ADAPTATION', 'DISPIDSPTSI', 'SpeechStreamFileMode',
    'SPWORDLIST', 'SRERequestUI', 'SGDSActiveWithAutoPause',
    'DISPID_SOTMatchesAttributes', 'DISPID_SOTId', 'DISPID_SRRTimes',
    'SRESoundEnd', 'ISpeechPhraseReplacements',
    'SpeechVoiceCategoryTTSRate', 'DISPID_SpeechFileStream', 'SASRun',
    'ISpeechVoice', 'SAFTCCITT_uLaw_11kHzStereo',
    'SpeechPropertyComplexResponseSpeed', 'SpeechAudioVolume',
    'SREAdaptation', 'SPAS_PAUSE', 'SGDSActiveUserDelimited',
    'DISPID_SRCVoice', 'DISPID_SPPsCount', 'SVP_16', 'ISpShortcut',
    'ISpeechPhraseProperties', 'DISPID_SRGRecoContext',
    'SPGS_DISABLED', 'SGDisplay', 'eLEXTYPE_RESERVED7',
    'SPEI_MIN_TTS', 'SDTReplacement', 'DISPID_SGRSTType',
    'SAFTADPCM_11kHzStereo', 'SDTDisplayText', 'SVP_21',
    'DISPID_SRRGetXMLErrorInfo', 'DISPID_SpeechMemoryStream',
    'SPBO_NONE', 'DISPID_SPPValue', 'eLEXTYPE_MORPHOLOGY',
    'DISPID_SPPFirstElement', 'DISPID_SRCEAdaptation',
    'DISPID_SRGRules', 'SAFT11kHz8BitStereo', 'SDTAudio',
    'SAFT24kHz16BitMono', 'DISPID_SFSOpen', 'DISPID_SVSkip',
    'SREPrivate', 'SPEVENTSOURCEINFO', 'SAFT22kHz16BitStereo',
    'SAFTCCITT_uLaw_11kHzMono', 'SVP_0', 'SpLexicon',
    'SPDKL_DefaultLocation', 'DISPID_SVGetVoices',
    'ISpeechRecognizerStatus', 'SPPHRASERULE',
    '__MIDL_IWinTypes_0009', 'DISPID_SRCEHypothesis', 'SP_VISEME_1',
    'SAFTGSM610_8kHzMono', 'SpeechVoiceSpeakFlags', 'SGRSTTWord',
    '_ISpeechVoiceEvents', 'DISPID_SLPType', 'Speech_Default_Weight',
    'SPSUnknown', 'SPSHORTCUTPAIR', 'DISPID_SPIProperties',
    'DISPID_SpeechPhraseRules', 'SECHighConfidence',
    'DISPID_SLPSymbolic', 'DISPID_SRCESoundStart',
    'ISpNotifyTranslator', 'SPEI_SR_AUDIO_LEVEL', 'SpeechAllElements',
    'SPFM_NUM_MODES', 'ISpeechTextSelectionInformation',
    'DISPID_SPIGetDisplayAttributes', 'SpeechRecognizerState',
    'eLEXTYPE_PRIVATE16', 'DISPID_SLWLangId', 'SITooQuiet',
    'DISPIDSPTSI_SelectionLength', 'DISPID_SVDisplayUI',
    'DISPID_SLPsItem', 'DISPID_SDKDeleteKey', 'ISpRecoCategory',
    'SAFT44kHz8BitStereo', 'SpeechVisemeFeature', 'SVSFParseMask',
    'SP_VISEME_0', 'DISPID_SpeechRecoContextEvents', 'SPEI_PHONEME',
    'SAFTADPCM_44kHzStereo', 'ISpeechRecoResultTimes',
    'DISPID_SRGCmdLoadFromFile', 'DISPID_SPIEnginePrivateData',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SAFT12kHz16BitMono',
    'SAFT44kHz16BitMono', 'DISPID_SMSSetData', 'SPEI_RESERVED6',
    'SPRULESTATE', 'DISPID_SLWs_NewEnum', '_SPAUDIOSTATE',
    'DISPID_SBSWrite', 'SAFT32kHz8BitMono', 'DISPID_SRRAudioFormat',
    'SpeechDictationTopicSpelling', 'DISPID_SPIReplacements',
    'ISpeechPhraseReplacement', 'DISPID_SpeechAudio',
    'SpeechCategoryAudioOut', 'DISPID_SPRuleParent', 'IEnumString',
    'eLEXTYPE_VENDORLEXICON', 'SP_VISEME_11', 'ISpNotifySource',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'SAFTADPCM_22kHzStereo',
    'DISPID_SGRSAddWordTransition', 'SPEI_RESERVED3',
    'SAFT12kHz8BitMono', 'DISPID_SPAStartElementInResult',
    'SVSFVoiceMask', 'ISpeechRecoGrammar', 'SRCS_Disabled',
    'DISPID_SPILanguageId', 'DISPID_SRCEPhraseStart',
    'DISPID_SRRSetTextFeedback'
]

_check_version('1.2.0', 1643461034.337745)
