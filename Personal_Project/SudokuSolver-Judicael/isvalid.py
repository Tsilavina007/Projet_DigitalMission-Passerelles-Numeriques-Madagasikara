...
# use is_valid_unit to check column, rown and grid
...
# s'il ne contient pas de doublons
...
# vérifie si un nombre num peut être
# placé dans la cellule (i, j) de la grille
