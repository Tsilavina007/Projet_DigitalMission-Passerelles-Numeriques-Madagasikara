...
__authors__ = ["Team E-DATE"]
__license__ = "Ouvre_Source"
__version__ = "1.0"
__date__ = "17 juillet 2023"
...
class MyApp():
    ...
    def __init__(self, parent):
        '''Constructor'''
        self.root = parent
        parent.title(" E-DATE Fanorona")
        
        btn = Button(parent, text="Jouer", command=self.openjouer , width=10, bd=3, font=("Algerian",20), bg="orange")
        btn.pack(pady=280)
    ...
    def openpropos(self):
        ...
        fenpropos.title(" E-DATE Fanorona >>> A propos")
    ...
    def openjouer(self):
        ...
        def askClosefenjeu():
            ...
            if askyesno(" E-DATE Fanorona >>> Quitter","Êtes vous sur de vouloir quitter ? Toute progression non-sauvegardée sera perdue."): #Si la personne confirme
                onClosefenjeu()

        def askrestart():
            '''Demande à l'utilisateur si il est sur de vouloir recommencer, si oui redémarre le jeu'''
            if askyesno(" E-DATE Fanorona >>> Nouvelle partie","Êtes vous sur de vouloir recommencer? Toute progression non-sauvegardée sera perdue."): #Si la personne confirme
                restart()            
        ...
        def interface():
            ...
            fenjeu.title(" E-DATE Fanorona >>> Jouer")
            ...
            background_jeu = PhotoImage(file="media/fanorona.png")
            background_label = Label(fenjeu, image=background_jeu)
            background_label.place(x=0, y=0, relwidth=1, relheight=1)

            game = Canvas(fenjeu, width=wcan_jeu, height=hcan_jeu, highlightthickness=0, bg="skyblue")           
            ...
            mainmenu.add_cascade(label = "Options", menu=menuFichier)
            mainmenu.add_cascade(label = "Aides", menu=menuHelp)
        ...
        def open_choix():
            ...
            choix.title("E-DATE Fanorona >>> Information")
        ...
        def place_pions():
            ...
            for i in range(len(pions_j1)):
                ...
                game.create_oval(x_pion-rayon, y_pion-rayon, x_pion+rayon, y_pion+rayon, fill=couleur_j1, outline="red")
            ...
            for i in range(len(pions_j2)):
                ...
                game.create_oval(x_pion-rayon, y_pion-rayon, x_pion+rayon, y_pion+rayon, fill=couleur_j2, outline="white")            
...
if __name__ == "__main__":
    ...
    background_menu = PhotoImage(file="media/fanorona.png")
    ...
    couleur_j1 = 'white'
    couleur_j2 = 'red'
    couleur_select = 'green'
    couleur_banned = 'orange'
