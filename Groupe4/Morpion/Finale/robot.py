...
iaegalite = 0
fenetre = Tk()
fenetre.geometry("800x450+250+250")
fenetre.title("Contre ordinateur")
fenetre.configure(bg = "#00A7EB") 
fenetre.resizable(width=False, height=False)


case1 = Canvas(fenetre,width="140", height ="100", background="black")
case1.place(x="80",y="20")
case2 = Canvas(fenetre,width="140", height ="100", background="black")
case2.place(x="80",y="120")
case3 = Canvas(fenetre,width="140", height ="100", background="black")
case3.place(x="80",y="220")
case4 = Canvas(fenetre,width="140", height ="100", background="black")
case4.place(x="220",y="20")
case5 = Canvas(fenetre,width="140", height ="100", background="black")
case5.place(x="220",y="120")
case6 = Canvas(fenetre,width="140", height ="100", background="black")
case6.place(x="220",y="220")
case7 = Canvas(fenetre,width="140", height ="100", background="black")
case7.place(x="360",y="20")
case8 = Canvas(fenetre,width="140", height ="100", background="black")
case8.place(x="360",y="120")
case9 = Canvas(fenetre,width="140", height ="100", background="black")
...
def ia():
    ...
    if case_confirm5 == 0 and p == 0:
        text55 = case5.create_text(70,50,text="O",font ="Impact 50",fill="red")
        case_confirm5 = 1
        x = x + 1
        p = 1
        check5 = 1
        ...
        if aleat == 1 and case_confirm1 == 0:
            text11 = case1.create_text(70,50,text="O",font ="Impact 50",fill="red")
            case_confirm1 = 1
            x = x + 1
            p = 1
            check1 = 1
        ...
        if aleat == 2 and case_confirm3 == 0 and p == 0:
            text33 = case3.create_text(70,50,text="O",font ="Impact 50",fill="red")
            case_confirm3 = 1
            x = x + 1
            p = 1
            check3 = 1
        ...
        if aleat == 3 and case_confirm7 == 0 and p == 0:
            text77 = case7.create_text(70,50,text="O",font ="Impact 50",fill="red")
            case_confirm7 = 1
            x = x + 1
            p = 1
            check7 = 1
        ...
        if aleat == 4 and case_confirm9 == 0 and p == 0:
            text99 = case9.create_text(70,50,text="O",font ="Impact 50",fill="red")
            case_confirm9 = 1
            x = x + 1
            p = 1
            check9 = 1
...
#------------------------------------------ intelligence artificielle en dessous -----------------------------------------------------------
    ...
    if joueur42 == "b" and joueur52 == "b" and p == 0:
        if case_confirm6 == 0:
            text66 = case6.create_text(70,50,text="O",font ="Impact 50",fill="red")
            case_confirm6 = 1
            x = x + 1
            p = 1
            check6 = 1
    ...
    if joueur62 == "b" and joueur52 == "b" and p == 0:
        if case_confirm4 == 0:
            text44 = case4.create_text(70,50,text="O",font ="Impact 50",fill="red")
            case_confirm4 = 1
            x = x + 1
            p = 1
            check4 = 1
    ...
    if joueur92 == "b" and joueur72 == "b" and p == 0:
        if case_confirm8 == 0:
            text88 = case8.create_text(70,50,text="O",font ="Impact 50",fill="red")
            case_confirm8 = 1
            x = x + 1
            p = 1
            check8 = 1
    ...
    if joueur12 == "b" and joueur32 == "b" and p == 0:
        if case_confirm2 == 0:
            text22 = case2.create_text(70,50,text="O",font ="Impact 50",fill="red")
            case_confirm2 = 1
            x = x + 1
            p = 1
            check2 = 1
    ...
    if joueur41 == "a" and joueur51 == "a" and p == 0:
        if case_confirm6 == 0:
            text6 = case6.create_text(70,50,text="O",font ="Impact 50",fill="red")
            case_confirm6 = 1
            x = x + 1
            p = 1
            check6 = 1
        ...
        if check1 == 0:
            ...
            if case_confirm1 == 0 and recomm == 0:
                ...
                if x == 0 or x == 2 or x == 4 or x == 6 or x == 8 :
                    text1 = case1.create_text(70,50,text="X",font ="Impact 50",fill="red")
                    case_confirm1 = 1
                    x = x + 1
                    joueur11 = "a"
                    nbr1 = 1
    ...
    def click2(event):
        ...
        if check2 == 0:
            ...
            if case_confirm2 == 0 and recomm == 0:
                check2=1
                if x == 0 or x == 2 or x == 4 or x == 6 or x == 8 :
                    text2 = case2.create_text(70,50,text="X",font ="Impact 50",fill="red")
                    case_confirm2 = 1
                    x = x + 1
                    joueur21 = "a"
                    nbr2 = 1
                    tourx.delete(ALL)
                    touromsg = touro.create_text(40,25,text="   au tour de\n            l'Ordinateur",fill="white",font="Impact 13")
    ...
    def click3(event):
        ...
        if check3 == 0:
            ...
            if case_confirm3 == 0 and recomm == 0:
                check3=1
                if x == 0 or x == 2 or x == 4 or x == 6 or x == 8 :
                    text3 = case3.create_text(70,50,text="X",font ="Impact 50",fill="red")
                    case_confirm3 = 1
                    x = x + 1
                    joueur31 = "a"
                    nbr3 = 1
    ...
    def click4(event):
        ...
        if check4 == 0:
            ...
            if case_confirm4 == 0 and recomm == 0:
                check4 =1
                if x == 0 or x == 2 or x == 4 or x == 6 or x == 8 :
                    text4 = case4.create_text(70,50,text="X",font ="Impact 50",fill="red")
                    case_confirm4 = 1
                    x = x + 1
                    joueur41 = "a"
                    nbr4 = 1
    ...
    def click5(event):
        ...
        if check5 == 0:
            ...
            if case_confirm5 == 0 and recomm == 0:
                check5 =1
                if x == 0 or x == 2 or x == 4 or x == 6 or x == 8  :
                    text5 = case5.create_text(70,50,text="X",font ="Impact 50",fill="red")
                    case_confirm5 = 1
                    x = x + 1
                    joueur51 = "a"
                    nbr5 = 1
    ...
    def click6(event):
        ...
        if check6 == 0:
            ...
            if case_confirm6 == 0 and recomm == 0:
                check6=1
                if x == 0 or x == 2 or x == 4 or x == 6 or x == 8 :
                    text6 = case6.create_text(70,50,text="X",font ="Impact 50",fill="red")
                    case_confirm6 = 1
                    x = x + 1
                    joueur61 = "a"
                    nbr6 = 1
    ...
    def click7(event):
        ...
        if check7 == 0:
            ...
            if case_confirm7 == 0 and recomm == 0:
                check7=1
                if x == 0 or x == 2 or x == 4 or x == 6 or x == 8 :
                    text7 = case7.create_text(70,50,text="X",font ="Impact 50",fill="red")
                    case_confirm7 = 1
                    x = x + 1
                    joueur71 = "a"
                    nbr7 = 1
    ...
    def click8(event):
        ...
        if check8==0:
            ...
            if case_confirm8 == 0 and recomm == 0:
                check8=1
                if x == 0 or x == 2 or x == 4 or x == 6 or x == 8 :
                    text8 = case8.create_text(70,50,text="X",font ="Impact 50",fill="red")
                    case_confirm8 = 1
                    x = x + 1
                    joueur81 = "a"
                    nbr8 = 1
    ...
    def click9(event):
        ...
        if check9==0:
            ...
            if case_confirm9 == 0 and recomm == 0:
                check9=1
                if x == 0 or x == 2 or x == 4 or x == 6 or x == 8 :
                    text9 = case9.create_text(70,50,text="X",font ="Impact 50",fill="red")
                    case_confirm9 = 1
                    x = x + 1
                    joueur91 = "a"
                    nbr9 = 1
...
def winO():
    ...
    if recomm == 0:
        ...
        checke = checke + "oui"
        messagewin.delete(ALL)
        messagewin1 = messagewin.create_text(130,15,text="bravo, l'Ordinateur a gagné !",fill="white",font="Impact 18")
        x = 0
        recomm = 1
        if checke == "oui":
            iagagne = iagagne + 1
...
def egalite():
    ...
    checke = checke + "oui"
    messagewin.delete(ALL)
    messagewin1 = messagewin.create_text(130,15,text="Dommage, vous avez fait égalité !",fill="white",font="Digital-7")
    x = 0
    recomm = 1
    if checke == "oui":
