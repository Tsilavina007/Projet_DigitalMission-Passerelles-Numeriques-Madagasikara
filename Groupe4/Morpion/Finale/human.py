...
x = 0
fenetre = Tk()
fenetre.geometry("600x450+400+300")
...
prenom = developer.create_text(101,11,text="developpé par E-DATE",fill="#00A7EB",font="Impact 11")
case_confirm1 = 0
case_confirm2 = 0
case_confirm3 = 0
case_confirm4 = 0
...
def winX():
    ...
    messagewin.delete(ALL)
    messagewin1 = messagewin.create_text(130,15,text="bravo, joueur X a gagne !",fill="white",font=("Digital-7", "bold"))
...
def winO():
    ...
    messagewin.delete(ALL)
    messagewin1 = messagewin.create_text(130,15,text="bravo, joueur O a gagne !",fill="white",font=("Digital-7", "bold"))
